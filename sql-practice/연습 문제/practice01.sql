...
select first_name 이름, gender 성별, hire_date 입사일 from employees order by hire_date;

-- 문제3. (count), 일단 지금은 쿼리 두개로 만들어도 됨
...
select title from titles where emp_no = '13250' order by from_date;